 ...
 *
 * Main dashboard page. First screen shows Makassar weather data by default.
 * Desktop: 12-column grid. Mobile: single-column stack.
 * Styled per DESIGN.md: Airy Modernism, glassmorphism, sky-blue palette.
 */
