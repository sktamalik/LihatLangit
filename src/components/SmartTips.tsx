  ...
  return(
    <div className="bg-white rounded-[16px] p-6 shadow-[0_4px_20px_rgba(0,0,0,0.04)] flex flex-col h-full">
      ...
      <div className="flex-grow divide-y divide-outline-variant/20">
        <div className="flex items-center gap-3 py-2"><div className="w-8 h-8 rounded-full bg-grass-green/10 flex items-center justify-center text-grass-green"><span className="material-symbols-outlined text-[16px]">monitor_heart</span></div><div><p className="text-[13px] font-semibold text-text-dark">Kesehatan</p><p className="text-[11px] text-text-muted">Hidrasi cukup</p></div></div>
        <div className="flex items-center gap-3 py-2"><div className="w-8 h-8 rounded-full bg-secondary/10 flex items-center justify-center text-secondary"><span className="material-symbols-outlined text-[16px]">router</span></div><div><p className="text-[13px] font-semibold text-text-dark">Rumah</p><p className="text-[11px] text-text-muted">{isRainy?"Jangan jemur":"Aman menjemur"}</p></div></div>
        <div className="flex items-center gap-3 py-2"><div className="w-8 h-8 rounded-full bg-primary-container/10 flex items-center justify-center text-primary-container"><span className="material-symbols-outlined text-[16px]">{isRainy?"umbrella":"sunny"}</span></div><div><p className="text-[13px] font-semibold text-text-dark">Aktivitas</p><p className="text-[11px] text-text-muted">{isRainy?"Bawa payung":"Nikmati hari"}</p></div></div>
      </div>
    </div>);
}
